...
.service(controllers::page::edit_page)
.service(controllers::page::get_page_by_slug)
.service(controllers::page::create_page)
.service(controllers::page::update_page)
.service(controllers::page::get_page_by_id)
.service(controllers::page::get_all_pages)
.service(controllers::page::get_page_details)
.service(controllers::image::upload_image)
.service(controllers::create_page_dashboard)
.service(controllers::page_dashboard)
