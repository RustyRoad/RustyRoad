...
"##;
    ...
    let path = Path::new("src/views/layouts/authenticated_page/page/page_details.html.tera");

    // create the file
    create_file(path.to_str().unwrap()).expect("Error creating the page_details.html.tera file");
