          ...
          <ul role='list' class='flex flex-1 flex-col gap-y-7'>
            <li>
              <ul role='list' class='-mx-2 space-y-1'>
                ...
                <li>
                  <a href='/pages' class='text-gray-700  hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold dark:hover:text-gray-100 dark:hover:bg-slate-900'>
