...
/// Returns `true` when the migration is currently applied.
///
...
/// Returns `true` when running `direction` would be a no-op: applying something
/// already applied, or rolling back something not applied.
