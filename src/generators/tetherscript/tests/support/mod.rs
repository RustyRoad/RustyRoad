//! Shared fixtures for TetherScript generation tests.
...
pub(super) use columns::required;
...
pub(super) fn resolve(
    table: &Table,
    schema: &Schema,
) -> crate::generators::tetherscript::model::Model {
